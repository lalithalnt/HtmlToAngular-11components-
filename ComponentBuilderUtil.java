	...
	public class ComponentBuilderUtil {
		...
		public void createSwingToHTMLComponents(Object object) {
			...
			if (object instanceof JPanel) {	
				...
				componentBuilder((JComboBox) object);
				...
				componentBuilder((JButton) object);
				...
				componentBuilder((JTabbedPane) object);
			}
		...
		public void componentBuilder(JTextArea panel) {
			...
			/*this.htmlBuilder.TextAreaCreator(null);*/
		...
		public void componentBuilder(JTabbedPane panel) {
			Component[] comp = panel.getComponents();
			// create JProgressBar and add components.
			componentBuilder(comp, null);
		}
			...
			if (comp != null && comp.length > 0) {
				...
				for (int i = 0; i < comp.length; i++) {
					...
					if (comp[i] instanceof JPanel) {
						...
						componentBuilder((JComboBox) comp[i]);
